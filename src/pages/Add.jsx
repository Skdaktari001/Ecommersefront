    ...
    <div className="max-w-4xl px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-12">
          <div className="space-y-1">
            ...
            <p className="text-[13px] text-slate-400 font-medium">Define metadata for a new collection product.</p>
          </div>
          <button 
      ...
      <form onSubmit={onSubmitHandler} className="space-y-8">
        ...
        <section className="bg-white p-8 md:p-10 rounded-[32px] border border-slate-100 shadow-xl shadow-slate-200/50">
          ...
          <p className="text-[11px] text-neutral-400 font-light mt-6 italic">Support JPG, PNG, WebP. Recommended ratio 4:5. Max 5MB each.</p>
        </section>
          ...
          <div className="space-y-10">
            <div className="space-y-3">
              ...
              <input
                ...
                type="text"
                placeholder="Ex. Noir Oversized Hoodie"
                required
              />
            </div>
